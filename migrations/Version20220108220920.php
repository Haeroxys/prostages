 ...
 */
final class Version20220108220920 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE entreprise (id INT AUTO_INCREMENT NOT NULL, activite VARCHAR(25) NOT NULL, adresse VARCHAR(100) NOT NULL, nom VARCHAR(25) NOT NULL, urlsite VARCHAR(100) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE stage (id INT AUTO_INCREMENT NOT NULL, entreprises_id INT NOT NULL, titre VARCHAR(50) NOT NULL, desc_mission VARCHAR(100) NOT NULL, email_contact VARCHAR(50) NOT NULL, INDEX IDX_C27C9369A70A18EC (entreprises_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
